...
def RichardsEQN_1D(psi, qTfun, p, qBot=qBot, psiTop=psiTop, psiBot=psiBot, qEva=qEva, qPrec=qPrec, qRoot=qRoot, qDrain=qDrain, hAtm=hAtm, hPond=hPond, dz=dz):  #, dt=dt, theta0=theta0):
...
# irrigation[0: int(22/ratio_t)] = -(0.001 / (pi * 0.22 * 0.22) / (22 * 60))
# irrigation[int(59/ratio_t): int(87/ratio_t)] = -(0.001 / (pi * 0.22 * 0.22) / (27 * 60))
# irrigation[int(161/ratio_t): int(189/ratio_t)] = -(0.001 / (pi * 0.22 * 0.22) / (27 * 60))
# irrigation[int(248/ratio_t): int(276/ratio_t)] = -(0.001 / (pi * 0.22 * 0.22) / (27 * 60))
# irrigation[int(335/ratio_t): int(361/ratio_t)] = -(0.001 / (pi * 0.22 * 0.22) / (25 * 60))
# irrigation[int(1590/ratio_t): int(1656/ratio_t)] = -(0.001 / (pi * 0.22 * 0.22) / (65 * 60))
...
# Take the average
thetaL_numpy_array_avg = zeros((len(timeList), 4))
