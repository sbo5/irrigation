...
# Initial guess: loam #####################################
# # Case: 2683: 10%
# Ks_p = 3.0333345e-06  # [m/s]
# Theta_s_p = 4.0850000e-01
# Theta_r_p = 7.4100000e-02
# Alpha_p = 3.4200000e+00
# N_p = 1.6380000e+00

# # Case: 2683: 30%
# Ks_p = 3.32222350e-06  # [m/s]
# Theta_s_p = 3.97938207e-01
# Theta_r_p = 7.93338514e-02
# Alpha_p = 3.06000001e+00
# N_p = 1.61664621e+00

Ks_i1 = 3.32222350e-06  # [m/s]
Theta_s_i1 = 3.97104031e-01
Theta_r_i1 = 8.04645726e-02
Alpha_i1 = 3.06000000e+00
N_i1 = 1.62786282e+00

Ks_i2 = 3.65444585e-06  # [m/s]
Theta_s_i2 = 3.94909738e-01
Theta_r_i2 = 7.82718194e-02
Alpha_i2 = 2.75400000e+00
N_i2 = 1.56184344e+00

Ks_p = 4.01989044e-06  # [m/s]
Theta_s_p = 4.00000000e-01
Theta_r_p = 7.56701704e-02
Alpha_p = 2.47860000e+00
N_p = 1.50929725e+00

# Initial guess: loamy sand #####################################
# # Case: 1444
# Ks_p = 4.45805556e-05  # [m/s]
# Theta_s_p = 3.69000000e-01
# Theta_r_p = 5.13000000e-02
# Alpha_p = 1.11600000e+01
# N_p = 2.50800000e+00

# # Case: 2683
# Ks_p = 3.6475e-05  # [m/s]
# Theta_s_p = 4.5100e-01
# Theta_r_p = 7.4100e-02
# Alpha_p = 7.4400e+00
# N_p = 2.0520e+00
...
# # Initial guess: Loam: only estimate alpha and n ######################
# Ks_p = 2.88889e-06  # [m/s]
# Theta_s_p = 0.43
# Theta_r_p = 0.078
# Alpha_p = 2.16
# N_p = 1.670047
...
def ini_state(p):
    hIni = ((((((thetaIni - p[2])/(p[1]-p[2])))**(1./(-(1-1/(p[4])))) - 1))**(1./(p[4])))/(-p[3])
...
def RichardsEQN_1D(x, t, u, p):
    ...
    for i in range(0, numberOfNodes):
        ...
        if i == 0:
            ...
            bc_zu = if_else(bc_zu>=1.0e-06, 1.0e-06, irr)
