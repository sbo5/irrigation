...
# plb = array([Ks*0.9, Theta_s, Theta_r, Alpha, N])
# pub = array([Ks*1.1, Theta_s, Theta_r, Alpha, N])
plb = array([Ks*0.6, 0.45, 0.075, 3.5, 1.4])
pub = array([Ks, 0.5, 0.084, 4.0, 1.7])
...
with open('Data/exp_data_flat_only.dat', 'r') as f:
    whole = f.readlines()
...
for i in range(0, interval):
    if i in range(1152, 1217):
        ...
        irr_amount[i] = 0
    # if i in range(410*ratio_t, 477*ratio_t):
    #     irr_amount[i] = (0.004/(pi*0.22*0.22)/(66*ratio_t*60))
    else:
        irr_amount[i] = 0
