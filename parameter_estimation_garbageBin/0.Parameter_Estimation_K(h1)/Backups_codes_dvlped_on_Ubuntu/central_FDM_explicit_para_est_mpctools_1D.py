...
def objective(p):
    ...
    for i in range(interval):
        if obj_fun == 1:
            if i % ratio_t == 0:
                j = int(i/ratio_t)
                obj += ((theta_p[j, 0] - theta_e[j, 0])) ** 2 + \
                       ((theta_p[j, 1] - theta_e[j, 1])) ** 2 + \
                       ((theta_p[j, 2] - theta_e[j, 2])) ** 2 + \
                       ((theta_p[j, 3] - theta_e[j, 3])) ** 2
        else:
            if i % ratio_t == 0:
                j = int(i/ratio_t)
                obj += ((hp[j, 0]-he[j, 0]))**2 + \
...
plt.plot(timeList_original/60.0, he[:, 1], 'b:', label=r'$h_2$ measured')
...
plt.plot(timeList_original/60.0, he[:, 2], 'b:', label=r'$h_3$ measured')
...
plt.plot(timeList_original/60.0, he[:, 3], 'b:', label=r'$h_4$ measured')
...
plt.plot(timeList_original/60.0, theta_e[:, 1], 'b-', label=r'$theta_2$ measured')
...
plt.plot(timeList_original/60.0, theta_e[:, 2], 'b:', label=r'$theta_3$ measured')
...
plt.plot(timeList_original/60.0, theta_e[:, 3], 'b:', label=r'$theta_4$ measured')
